...
import 'package:online_school/modules/launch/advertisement_page.dart';
...
import '../../common/tools/logger.dart';
import '../../common/tools/share_preference.dart';
...
class _AppState extends State<App> {
  ...
  Future<void> initPlatformState() async {
    ...
    jpush.setup(
      ...
      channel: (await WangxiaoPlugin.getChannel) ?? 'dev',
      production: false,
      debug: true,
    );
