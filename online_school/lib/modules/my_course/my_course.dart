        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            FlatButton(
              ...
              onPressed: () async {
//                UserInfoModel userInfo = store.state.userInfo;
//
//                String avatar = userInfo.data != null ? userInfo.data.userPhoto : "";
...
//                var argument = {
//                  "channelId":"1798956",
//                  "appUserId":userInfo.data != null ? "${userInfo.data.userId}" : "",
//                  "appUserName":userInfo.data != null ? userInfo.data.userName : "",
//                  "appAvatar":avatar
//                };
//                var result = await _methodChannel.invokeMethod("live", argument);
//                print("调用保利威直播页面回调结果:$result");
