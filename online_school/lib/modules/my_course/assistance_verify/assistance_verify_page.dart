                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          RealRichText([
                                            ...
                                            TextSpan(
                                              text: reviewStatusModel.data.mobile == null ? "未绑定" + "，如需修改手机号，请联系客服。" : reviewStatusModel.data.mobile + "，如需修改手机号，请联系客服。",
                                              style: TextStyle(color: Color(0xff873FFF), fontSize: 14),
                                            ),
                                          ]),
                                          Padding(padding: EdgeInsets.only(top: 15)),
                                          SizedBox(
