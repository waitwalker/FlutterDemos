...
class VideoViewControlleryige extends StatefulWidget {
  final String id;
  final int pageNum;
  final int pageSize;
  VideoViewControlleryige(this.id, this.pageNum, this.pageSize);
...
class VideoViewControllerState extends State<VideoViewControlleryige> {
